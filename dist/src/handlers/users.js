...
var createUserAfterLogin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
var userRoutes = function (app) {
    app.get('/users', general_1.default, index);
    app.get('/user/:id', general_1.default, showUser);
    app.post('/user', createUser);
    app.post('/user-after-login', general_1.default, createUserAfterLogin);
};
