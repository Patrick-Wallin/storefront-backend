...
var showTopFivePopular = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.showTopFivePopular()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
...
var showByCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productBasedOnCategoryRecords, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.showByCategory(parseInt(req.params.categoryid))];
            case 1:
                productBasedOnCategoryRecords = _a.sent();
